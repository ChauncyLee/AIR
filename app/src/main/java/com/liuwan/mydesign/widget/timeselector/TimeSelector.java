package com.liuwan.mydesign.widget.timeselector;
...
public class TimeSelector {
    ...
    private TextView tv_cancle, tv_commit, hour_text, minute_text;
    ...
    private void initDialog() {
        if (timePickerDialog == null) {
            timePickerDialog = new Dialog(context, R.style.time_dialog);
            timePickerDialog.setCancelable(false);
            timePickerDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            timePickerDialog.setContentView(R.layout.dialog_timeselector);
            Window window = timePickerDialog.getWindow();
            window.setGravity(Gravity.BOTTOM);
            WindowManager.LayoutParams lp = window.getAttributes();
            DisplayUtil.getScreenSize(context);
            lp.width = DisplayUtil.getScreenSize(context)[0];
            window.setAttributes(lp);
        }
    }

    private void initView() {
        year_pv = (PickerView) timePickerDialog.findViewById(R.id.year_pv);
        month_pv = (PickerView) timePickerDialog.findViewById(R.id.month_pv);
        day_pv = (PickerView) timePickerDialog.findViewById(R.id.day_pv);
        hour_pv = (PickerView) timePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (PickerView) timePickerDialog.findViewById(R.id.minute_pv);
        tv_cancle = (TextView) timePickerDialog.findViewById(R.id.tv_cancle);
        tv_commit = (TextView) timePickerDialog.findViewById(R.id.tv_commit);
        hour_text = (TextView) timePickerDialog.findViewById(R.id.hour_text);
        minute_text = (TextView) timePickerDialog.findViewById(R.id.minute_text);
